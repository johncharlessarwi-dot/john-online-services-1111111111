...
import { LayoutDashboard, Package, CreditCard, Files, Bell, User, Settings, LogOut } from "lucide-react";
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed bottom-4 right-4 p-3 bg-primary-600 text-white rounded-full shadow-lg"
      >
        ☰
      </button>
